...
$smtp_username = 'patrasagarika654@gmail.com';  // Your email
$smtp_password = 'dqnk duhw jwxz uydo';         // Your app password
$smtp_from = 'patrasagarika654@gmail.com';      // From email address
$smtp_from_name = 'Police Station Form';        // From name
$smtp_to = 'patrasagarika654@gmail.com';        // Recipient email address
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $zone = isset($_POST['zone']) ? sanitize_input($_POST['zone']) : '';
    ...
    $requiredFileFields = ['aadhar-card', 'passport-photo'];
    ...
    if (empty($errors)) {
        ...
        // Email subject
        $subject = "Police Station Form: $letterNo";
        ...
        $body .= "<html><body>";
        $body .= "<h2>Police Station Form Details</h2>";
        ...
        $body .= "<p><strong>Ward:</strong> $zone</p>";
        ...
        if ($result) {
            ...
            $response['message'] = "Your form has been submitted successfully. Reference Number: $letterNo";
            
            // Redirect to success page or show success message
            header("Location: success.php?ref=$letterNo&form=police");
            exit();
        } else {
...
if (!$response['success'] && !empty($response['message'])) {
    header("Location: police-station.html?error=" . urlencode($response['message']));
    exit();
}
?>