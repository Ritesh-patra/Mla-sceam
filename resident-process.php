...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('patrasagarika654@gmail.com', 'Resident Certificate System');
        $mail->addAddress('patrasagarika654@gmail.com'); // Admin email
        $mail->addReplyTo($email, $full_name);
        
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'New Resident Certificate Application from ' . $full_name;
        
        // Email body
        $body = "
        <h2>New Resident Certificate Application</h2>
        ...
        echo "<script>alert('Your Resident Certificate application has been submitted successfully!'); window.location.href = 'resident-certificate.html';</script>";
